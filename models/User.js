...
User.prototype.validate = function() {
    return new Promise(async (resolve, reject) => {
        ...
        if (this.data.username != "" && !validator.isAlphanumeric(this.data.username)) {this.errors.push("Username can only contain only letters and numbers")}
        ...
        if (this.data.username.legnth > 30) {this.errors.push("Username cannot exceed 100 characters.")}
...
User.prototype.register = function() {
    return new Promise(async (resolve, reject) => {
        ...
        // Step #2: Only if there is no validation errors store user data into a database
