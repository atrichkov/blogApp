...
export default class RegistrationForm {
    ...
    events() {
        ...
        this.username.addEventListener("keyup", () => {
            this.isValueUpdated(this.username, this.usernameHandler)
        })
        this.email.addEventListener("keyup", () => {
            this.isValueUpdated(this.email, this.emailHandler)
        })
        this.password.addEventListener("keyup", () => {
            this.isValueUpdated(this.password, this.passwordHandler)
        })
    ...
    usernameHandler() {
        ...
        clearTimeout(this.username.timer) // Make sure that timeout below don't stack
    ...
    passwordHandler() {
        ...
        this.passwordImmediatly()
        clearTimeout(this.password.timer) // Make sure that timeout below don't stack
    ...
    usernameAfterDelay() {
        ...
        if (!this.username.errors) {
            axios.post('/doesUsernameExist', {_csrf: this._csrf, username: this.username.value}).then((response) => {
                ...
                console.error("Please try again latter")
            })
        }
    }
